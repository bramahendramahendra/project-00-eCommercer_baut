<template>
    <div class="mt-8 flow-root animate-fade-in-down">
        <div class="flex justify-between border-b-2 pb-3">
            ...
            <div>
                <input v-model="search" @change="getProducts(null)" class="appearance-none relative block w-48 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Cari Kategori">
            </div>
        </div>
        ...
        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <table class="min-w-full divide-y divide-gray-300">
                    <thead>
                        <tr>
                            <TableHeaderCell @click="sortProduct" scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-3" field="id" :sort-field="sortField" :sort-direction="sortDirection">ID</TableHeaderCell>
                            <TableHeaderCell @click="sortProduct" scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900" field="category_name" :sort-field="sortField" :sort-direction="sortDirection">Kategori</TableHeaderCell>
                            <TableHeaderCell @click="sortProduct" scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900" field="type_name" :sort-field="sortField" :sort-direction="sortDirection">Jenis</TableHeaderCell>
                            <TableHeaderCell @click="sortProduct" scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900" field="code" :sort-field="sortField" :sort-direction="sortDirection">Kode</TableHeaderCell>
                            <TableHeaderCell @click="sortProduct" scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900" field="title" :sort-field="sortField" :sort-direction="sortDirection">Judul</TableHeaderCell>
                            <TableHeaderCell @click="sortProduct" scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900" field="updated_at" :sort-field="sortField" :sort-direction="sortDirection">Last Updated At</TableHeaderCell>
                    ...
                    <tbody v-else class="bg-white">
                        <tr v-for="(product, index) of products.data" class="even:bg-gray-50">
                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">{{ product.id }}</td>
