...
class ProductResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'contents_per_box_unit_short_name' => $this->contentsPerBoxUnit->short_name ?? null, 
            'contents_per_box_unit_full_name' => $this->contentsPerBoxUnit->full_name ?? null, 
            'contents_per_box_unit_symbol' => $this->contentsPerBoxUnit->symbol ?? null, 
            ...
            'length_unit_short_name' => $this->lengthUnit->short_name ?? null, 
            'length_unit_full_name' => $this->lengthUnit->full_name ?? null, 
            'length_unit_symbol' => $this->lengthUnit->symbol ?? null, 
            // thick_head
            ...
            'thick_head_unit_short_name' => $this->thickHeadUnit->short_name ?? null, 
            'thick_head_unit_full_name' => $this->thickHeadUnit->full_name ?? null, 
            'thick_head_unit_symbol' => $this->thickHeadUnit->symbol ?? null, 
            // drat_length
            ...
            'drat_length_unit_short_name' => $this->dratLengthUnit->short_name ?? null, 
            'drat_length_unit_full_name' => $this->dratLengthUnit->full_name ?? null, 
            'drat_length_unit_symbol' => $this->dratLengthUnit->symbol ?? null, 
            // others 
