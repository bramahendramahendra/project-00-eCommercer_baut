...
class ProductFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'unit_id' => fake()->numberBetween(1, 30),
            'material_id' => fake()->numberBetween(1, 30),
            'weight' => fake()->randomNumber(2,2,2),
            'unit_weight_id' => fake()->numberBetween(1, 30),
            'contents_per_box' => fake()->unique()->randomNumber(2),
            'unit_contents_per_box_id' => fake()->numberBetween(1, 30),
            'grade' => fake()->randomNumber(2,2,2),
            'thread_direction_id' => fake()->numberBetween(1, 30),
            'thread_density_id' => fake()->numberBetween(1, 30),
            'diameter' => fake()->randomNumber(2,2,2),
            'inner_diameter' => fake()->randomNumber(2,2,2),
            'outer_diameter' => fake()->randomNumber(2,2,2),
            'unit_diameter_id' => fake()->numberBetween(1, 30),
            'length' => fake()->randomNumber(2,2,2),
            'unit_length_id' => fake()->numberBetween(1, 30),
            ...
            'unit_thick_head_id' => fake()->numberBetween(1, 30),
            'across_flats' => fake()->text(10),
            'drat_type' => fake()->text(10),
            'drat_length' => fake()->randomNumber(2,2,2),
            'unit_drat_length_id' => fake()->numberBetween(1, 30),
