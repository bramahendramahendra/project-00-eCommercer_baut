<x-app-layout>
    <div>
        <main class="isolate">
                ...
                <div class="overflow-hidden">
                    <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                        <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                            ...
                            <div x-data="{
                                    aboutHeaderImage:[
                                        @foreach ($aboutHeaderImages as $headerImage)
                                ...
                                <div class="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                                    <div class="relative">
                                        <img :src="aboutHeaderImage[0].src" :alt="aboutHeaderImage[0].alt" class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10"></div>
                                    </div>
                                </div>
                                <div class="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                                    <div class="relative">
                                        <img :src="aboutHeaderImage[1].src" :alt="aboutHeaderImage[1].alt" class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10"></div>
                                    </div>
                                    <div class="relative">
                                        <img :src="aboutHeaderImage[2].src" :alt="aboutHeaderImage[2].alt" class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10"></div>
                                    </div>
                                </div>
                                <div class="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                                    <div class="relative">
                                        <img :src="aboutHeaderImage[3].src" :alt="aboutHeaderImage[3].alt" class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10"></div>
                                    </div>
                                    <div class="relative">
                                        <img :src="aboutHeaderImage[4].src" :alt="aboutHeaderImage[4].alt" class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg">
                                        <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10"></div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Image section -->
            <div  x-data="{
                    aboutFooterImage: { src: '{{ $aboutFooterImages[0]->image }}', alt: '{{ $aboutFooterImages[0]->slug }}' },
                }" class="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
                <img :src="aboutFooterImage.src" :alt="aboutFooterImage.alt" class="aspect-[5/2] w-full object-cover xl:rounded-3xl">
            </div>
        </main>
    </div>
</x-app-layout>