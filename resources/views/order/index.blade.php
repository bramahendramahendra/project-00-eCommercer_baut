    ...
    <div>
        <div class="bg-white">
            <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:pb-24">
                <div class="max-w-xl">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{{ __('Order history') }}</h1>
                    <p class="mt-2 text-sm text-gray-500">
                        {{ __('Check the status of recent orders, manage returns, and download invoices.') }}
                    </p>
                </div>
 {{-- {{ var_dump($orders) }} --}}
                <div class="mt-16">
                                ...
                                <div
                                    ...
                                    <div x-data="{openModal: false}">     
                                        <a @click="openModal = true" 
                                            href="#" class="mt-6 flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-baut-color-red-200 focus:ring-offset-2 sm:mt-0 sm:w-auto">
                                            {{ __('Lihat Invoice') }}
                                                                    ...
                                                                    <div class="mt-2">
                                                                        <main
                                                                            ...
                                                                            <div class="mx-auto max-w-3xl">
                                                                                <div class="max-w-xl">
                                                                                    <h1 class="text-base font-medium {{ $order->isPaid() ? 'text-emerald-500' : 'text-yellow-600' }}">
                                                                                    ...
                                                                                    <p class="mt-2 text-base text-gray-500">
                                                                                        {{ __('Pesanan produk ') }}{{ $order->id }}{{ $order->isPaid()?' sudah selasai pembayaran.':' masih dalam proses.' }}
                                                                                    </p>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="sm:ml-40 sm:pl-6">
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <address class="not-italic">
                                                                                                <span class="block">{{$order->user->customer->shippingAddress->address1}} {{$order->user->customer->shippingAddress->address2}}</span>
                                                                                                <span class="block">{{$order->user->customer->shippingAddress->city}}, {{$order->user->customer->shippingAddress->state}}</span>
                                                                                                <span class="block">{{$order->user->customer->shippingAddress->country}}, {{$order->user->customer->shippingAddress->zipcode}}</span>
                                                                                            </address>
                                                                                            </dd>
                                                                                        </div>
                                                                                        <div>
                                                                                            ...
                                                                                            <dd class="mt-2 text-gray-700">
                                                                                            <address class="not-italic">
                                                                                                <span class="block">{{$order->user->customer->billingAddress->address1}} {{$order->user->customer->billingAddress->address2}}</span>
                                                                                                <span class="block">{{$order->user->customer->billingAddress->city}}, {{$order->user->customer->billingAddress->state}}</span>
                                                                                                <span class="block">{{$order->user->customer->billingAddress->country}}, {{$order->user->customer->billingAddress->zipcode}}</span>
                                                                                            </address>
                                                                                            </dd>
                                                                                        </div>
                                                                                        </dl>
                                                                                        ...
                                                                                        <div x-data="invoiceData({{ $order->items->toJson() }})" x-init="init">
